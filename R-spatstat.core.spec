...
Version  : 2.3.2
Release  : 8
URL      : https://cran.r-project.org/src/contrib/spatstat.core_2.3-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.core_2.3-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641128439
